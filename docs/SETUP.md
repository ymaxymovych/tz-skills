...
на які сам не зміг відповісти (типово 0-3) — кожне вже з рекомендованою відповіддю і
поясненням чому. Вихід у будь-який момент — кодове слово «ФІНІШ» (= «приймаю твої
рекомендації, видавай ТЗ»):
