...
- **`/tz-go`** — **весь конвеєр одним викликом, без жодного очікування.** Для режиму
  ...
  правкою), проганяє повний `/tz-review`, а тоді реалізує фінальне ТЗ фаза за фазою
  до останнього критерію приймання — не зупиняючись і нічого не перепитуючи. Ставка явна: ~80% само-відповідей
